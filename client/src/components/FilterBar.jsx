...
export default function FilterBar({ labels, swimlaneMode, onToggleSwimlaneMode, filters, onFiltersChange, compactView, onToggleCompactView, viewMode, onViewModeChange }) {
  return (
